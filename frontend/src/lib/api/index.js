...
export const adminAPI = {
  ...
  getHubs: () => apiClient.get(API_ENDPOINTS.ADMIN.HUBS),
  getHubById: (id) =>
    apiClient.get(API_ENDPOINTS.ADMIN.HUB_BY_ID.replace(":id", id)),
  createHub: (data) => apiClient.post(API_ENDPOINTS.ADMIN.HUBS, data),
  updateHub: (id, data) =>
    apiClient.put(API_ENDPOINTS.ADMIN.HUB_BY_ID.replace(":id", id), data),
  updateHubZones: (id, zoneIds) =>
    apiClient.put(API_ENDPOINTS.ADMIN.HUB_ZONES.replace(":id", id), {
      zoneIds,
    }),
  resetHubPassword: (id, password, confirmPassword) =>
    apiClient.post(API_ENDPOINTS.ADMIN.HUB_RESET_PASSWORD.replace(":id", id), {
      password,
      confirmPassword,
    }),
  disableHub: (id) =>
    apiClient.patch(API_ENDPOINTS.ADMIN.HUB_DISABLE.replace(":id", id)),
  enableHub: (id) =>
    apiClient.patch(API_ENDPOINTS.ADMIN.HUB_ENABLE.replace(":id", id)),

  // Hub self-profile (Hub Manager)
  getCurrentHubProfile: () => apiClient.get(API_ENDPOINTS.ADMIN.HUB_ME),
  updateCurrentHubProfile: (data) =>
    apiClient.put(API_ENDPOINTS.ADMIN.HUB_ME_UPDATE, data),
  changeCurrentHubPassword: (data) =>
    apiClient.post(API_ENDPOINTS.ADMIN.HUB_ME_CHANGE_PASSWORD, data),
